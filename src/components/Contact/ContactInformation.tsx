  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        {t("contact_us_information")}
      </p>
      <div className="max-w-2xl mx-auto bg-white rounded-lg">
        <p className="text-gray-700 mb-2">
          📍 <span className="font-semibold">Address:</span> 364, Brigstock Road
        </p>
        <p className="text-gray-700 mb-2">
          📞 <span className="font-semibold">Phone:</span> +44 7765104623
        </p>
        <p className="text-gray-700 mb-4">
          📧 <span className="font-semibold">Email:</span>{" "}
          <a
            href={`mailto:keyur2523@gmail.com`}
